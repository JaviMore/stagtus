...
#define LV_FONT_CUSTOM_DECLARE   LV_FONT_DECLARE(game_14) LV_FONT_DECLARE(game_20) LV_FONT_DECLARE(game_24) LV_FONT_DECLARE(game_34) LV_FONT_DECLARE(game_38) LV_FONT_DECLARE(game_40) LV_FONT_DECLARE(game_48)

/*Always set a default font*/
#define LV_FONT_DEFAULT &game_14
